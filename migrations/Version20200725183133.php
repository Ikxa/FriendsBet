 ...
 */
final class Version20200725183133 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, sport_id INT DEFAULT NULL, team_one VARCHAR(255) NOT NULL, team_two VARCHAR(255) NOT NULL, played_at DATETIME NOT NULL, score VARCHAR(100) NOT NULL, is_over TINYINT(1) NOT NULL, INDEX IDX_7A5BC505AC78BCF8 (sport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
